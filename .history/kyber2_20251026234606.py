...
class DistributedHashTable:
    """
    Simplified DHT for secure ciphertext routing with automatic expiry.
    Stores middle portions of split ciphertexts temporarily.
    """
    ...
    def put(self, key: str, value: any, ttl: int = None) -> bool:
        """Store value in DHT with optional TTL"""
        with self.lock:
    ...
    def reset(self):
        """Clear all DHT entries (periodic reset)"""
        with self.lock:
